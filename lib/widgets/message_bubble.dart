...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        if (isGlobalMessage && isFirstInSequence)
          Positioned(
            top: 15,
        ...
        Container(
          ...
          // user's image.
          margin: EdgeInsets.symmetric(horizontal: isGlobalMessage ? 46 : 0),
          child: Row(
